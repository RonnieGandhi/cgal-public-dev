...
#ifndef CGAL_SHAPE_DETECTION_REGION_GROWING_3_H
#define CGAL_SHAPE_DETECTION_REGION_GROWING_3_H
...
*/
  ...
  public:
    ...
    typedef CGAL::Shape_detection_simon_3::Plane<Traits> Plane_shape; ///< shape type.
